...
export function ErrorMessage({
  ...
  return (
    <div
      role="alert"
      className="flex min-w-0 flex-col gap-3 overflow-hidden rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 sm:flex-row sm:items-start sm:justify-between"
    >
